class Locator:
    locator2 = ('XPATH', '//*[@id="js-contribution-activity"]/div[2]/div/div/div[2]/details/summary/span[2]/span[2]')
    locator3 = ('XPATH', '//span[@class="Details-content--closed float-right"]')
    locator1 = ('XPATH', '//span[@class="d-inline-block float-right"]')
